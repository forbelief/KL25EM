#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\other\\LandzoOLED.c"
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\other\\LandzoOLED.h"
...
#line 5 "F:\\KL25EM\\KL25EM_dfxx\\src\\other\\LandzoOLED.h"
/********************************************************************/
/*-----------------------------------------------------------------------
LCD_init          : OLED初始化
...
#line 2 "F:\\KL25EM\\KL25EM_dfxx\\src\\other\\LandzoOLED.c"
...
#line 20 "F:\\KL25EM\\KL25EM_dfxx\\src\\other\\LandzoOLED.c"
...
//电(0) 磁(1) 组(2) 孙(3) 大(4) 敬(5) 薛(6) 晓(7) 良(8) 宋(9) 星(10) 组(11) 长(12)


0x00,0x00,0xF0,0x90,0x90,0x90,0xFE,0x90,0x90,0x90,0xF0,0x10,0x00,0x00,0x00,0x00,
0x0F,0x04,0x04,0x04,0x7F,0x44,0x44,0x44,0x4F,0x50,0x60,0x00,/*"电",0*/

0x00,0x00,0xF8,0x88,0x84,0x10,0xD0,0x7C,0x90,0x90,0x7C,0x12,0x90,0x00,0x00,0x03,
0x7F,0x20,0x3F,0x67,0x5C,0x3F,0x60,0x23,0x5E,0x43,0x60,0x00,/*"磁",1*/

0x00,0x60,0x58,0xC6,0x60,0x10,0xFC,0x44,0x44,0x44,0xFC,0x04,0x00,0x00,0x00,0x24,
0x27,0x24,0x10,0x50,0x7F,0x44,0x44,0x44,0x7F,0x40,0x60,0x40,/*"组",2*/

0x00,0x04,0x04,0xE4,0x9C,0x44,0x40,0xE0,0x00,0xFE,0x40,0x80,0x00,0x00,0x00,0x02,
0x01,0x7F,0x00,0x18,0x07,0x00,0x40,0x7F,0x00,0x01,0x0E,0x00,/*"孙",3*/
...
0x00,0x88,0x68,0x5E,0x48,0x5E,0xC8,0xC8,0xF0,0x2E,0x20,0xE0,0x10,0x00,0x00,0x01,
0x1F,0x09,0x0F,0x41,0x7E,0x41,0x21,0x16,0x1E,0x21,0x40,0x00,/*"敬",5*/

0x00,0xC0,0x28,0x58,0xFC,0x4A,0x48,0xC8,0x5E,0x68,0xC8,0x48,0x44,0x00,0x00,0x1E,
0x29,0x29,0x39,0x00,0x02,0x12,0x13,0x7E,0x13,0x0A,0x02,0x00,/*"薛",6*/

0x00,0xF8,0x88,0x88,0xF8,0x10,0x10,0x1E,0xF0,0xD0,0xB8,0x08,0xC8,0x00,0x00,0x1F,
0x10,0x90,0x9F,0x45,0x3D,0x05,0x04,0x7C,0x42,0x43,0x71,0x00,/*"晓",7*/

0x00,0x00,0x00,0xF8,0x48,0x48,0x4E,0x48,0x48,0xF8,0x08,0x00,0x00,0x00,0x00,0x00,
0x00,0x7F,0x42,0x22,0x2E,0x12,0x2A,0x25,0x46,0x40,0x00,0x00,/*"良",8*/

0x00,0xA0,0x98,0x90,0x90,0x90,0xCA,0xB4,0x90,0x90,0x90,0x90,0x80,0x00,0x00,0x40,
0x20,0x10,0x0C,0x02,0x3F,0x01,0x02,0x0C,0x18,0x30,0x20,0x00,/*"宋",9*/

0x00,0x00,0x00,0xFC,0x54,0x54,0x54,0xD4,0x54,0x54,0x7E,0x00,0x00,0x00,0x00,0x48,
0x46,0x41,0x52,0x52,0x7F,0x52,0x52,0x52,0x4A,0x40,0x40,0x00,/*"星",10*/

0x00,0x80,0x80,0xFC,0x80,0xC0,0xA0,0x90,0x88,0x84,0x84,0x80,0x80,0x00,0x00,0x00,
0x00,0x3F,0x40,0x20,0x21,0x16,0x08,0x18,0x10,0x20,0x20,0x00,/*"长",12*/  
};
...
void OLED_WrDat(uint8_t data)
{
  ...
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR3=1;
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR2=0;
  while(i--)
  {
    if(data&0x80)
    {
      ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR1=1;
    }
    else
    {
      ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR1=0;
    }
    ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR2=1;
    asm("nop");
    ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR2=0;
    data<<=1;
  }
...
void OLED_WrCmd(uint8_t cmd)
{
  ...
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR3=0;;
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR2=0;;
...
void OLED_Init(void)
{
  ...
  gpio_init (PTE3, GPO,1u);
  gpio_init (PTE4, GPO,1u);
  gpio_init (PTE5, GPO,0u);
  
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR2=1;
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR4 = 0 ; ///使能信号端，拉低时正常使用
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR5=0;
  OLED_DLY_ms(50);
  ((GPIO_MemMapPtr)0x400FF100u)->PDORs . PDOR5=1;
  ...
  OLED_Set_Pos(0,0);
   ...
   OLED_Fill(0x00);//黑屏 
   //OLED_DLY_ms(1500); 
   OLED_Print_Str(5,0,"kl25_电磁");  //汉字字符串显示
   OLED_Print_Str(5,2,"组长:孙大敬");  //汉字字符串显示
   OLED_Print_Str(5,4,"薛晓良");  //汉字字符串显示
   OLED_Print_Str(5,6,"宋星");  //汉字字符串显示
