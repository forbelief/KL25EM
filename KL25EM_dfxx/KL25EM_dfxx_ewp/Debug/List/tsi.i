#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\tsi\\tsi.c"
//============================================================================
//文件名称：hw_tsi.c
...
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\tsi\\tsi.h"
//============================================================================
//文件名称：hw_tsi.h
...
void  enter_critical(void);
void  exit_critical(void);
#line 13 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\tsi\\tsi.h"
...
#line 9 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\tsi\\tsi.c"
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\KL25EM_dfxx_ewp\\..\\src\\common\\common.h"
/******************** (C) COPYRIGHT 2011 蓝宙电子工作室 ********************
 * 文件名       ：arm_cm4.h
 * 描述         ：工程模版实验
...
void  enter_critical(void);
void  exit_critical(void);
#line 10 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\tsi\\tsi.c"
//============================================================================
//函数名称：hw_tsi_init                                                  
//功能概要：初始化TSI模块                                                  
...
{
	//开启TSI时钟
	((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= (0x20u) | (0x200u);
	//通道5使能
	((((PORT_MemMapPtr)0x40049000u))->PCR[4]) = (((uint32_t)(((uint32_t)(0))<<8))&0x700u); 
    //配置TSI通用寄存器
	 ((((TSI_MemMapPtr)0x40045000u))->GENCS) |= ((((uint32_t)(((uint32_t)(4))<<21))&0xE00000u)
				| (((uint32_t)(((uint32_t)(0))<<19))&0x180000u)
				| (((uint32_t)(((uint32_t)(6))<<16))&0x70000u)
				| (((uint32_t)(((uint32_t)(2))<<13))&0xE000u)
				| (((uint32_t)(((uint32_t)(11))<<8))&0x1F00u)
				| 0x40u
				| 0x20u
	);
	 
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) &= ~0x10000000u;
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) &= ~0x10u;
	//清越值标志位和扫描完成位
	((((TSI_MemMapPtr)0x40045000u))->GENCS) |= (0x80000000u) | (0x4u);
	//选择通道
	((((TSI_MemMapPtr)0x40045000u))->DATA) |= ((((uint32_t)(((uint32_t)(chnlID))<<28))&0xF0000000u)); 
	//TSI使能
	((((TSI_MemMapPtr)0x40045000u))->GENCS) |= (0x80u);
}
...
uint_16 hw_tsi_get_value16()
{
	...
	uint_16 value;        
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) &= ~0x40u;    
	//开启软件中断
	((((TSI_MemMapPtr)0x40045000u))->DATA) |= 0x400000u;
    //等待扫描完成   
	while(!(((((TSI_MemMapPtr)0x40045000u))->GENCS) & 0x4u));
	((((TSI_MemMapPtr)0x40045000u))->GENCS) |= 0x4u;
    //读取计数寄存器中的值
	value =  (((((TSI_MemMapPtr)0x40045000u))->DATA) & 0xFFFFu); 
	//清超出范围标志位
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) |= 0x80000000u; 
    //清扫描结束标志位    
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) |= 0x4u;
    //TSI中断使能
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) |= 0x40u;      
...
void hw_tsi_set_threshold(uint_16 low, uint_16 high)
{
    ...
    ((((TSI_MemMapPtr)0x40045000u))->TSHD) = thresholdValue;
}
...
void tsi_enable()
{
    ((((TSI_MemMapPtr)0x40045000u))->GENCS) |= (0x40u|0x10u);
    //开中断控制器IRQ中断
    enable_irq(26);   
}
