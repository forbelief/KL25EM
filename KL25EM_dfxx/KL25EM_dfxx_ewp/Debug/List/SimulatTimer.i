#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\app\\SimulatTimer.c"
/*
 *文件：	SimulatTimer.c
 *目的：	实现一个毫秒模拟定时器
 *
...
#line 13 "F:\\KL25EM\\KL25EM_dfxx\\src\\app\\include.h"
...
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\pit\\pit.h"
//==========================================================================
//文件名称：pit.h
//功能概要：KL25 pit底层驱动程序头文件
//版权所有：苏州大学飞思卡尔嵌入式中心(sumcu.suda.edu.cn)
...
#line 11 "F:\\KL25EM\\KL25EM_dfxx\\src\\app\\SimulatTimer.h"
...
#line 8 "F:\\KL25EM\\KL25EM_dfxx\\src\\app\\SimulatTimer.c"





static volatile SimulatTimerMs_T SimulatTimerMsVal[8];	//模拟定时器的硬件寄存器
...
uint_8 InitSimulatTimerMs(uint_8 n, SimulatTimerMsMode_T SimulatTimerMsMode, uint_32 cmr_ms)
{
	if(SimulatTimerMsVal[n].flag.ten == 1 && n >= 8)		//模拟定时器已打开或不存在，返回错误
		return ~0;
...
void SimulatTimerMsF_PIT_ISR()
{
	...
	if((((((PIT_MemMapPtr)0x40037000u))->CHANNEL[PIT1]. TFLG) & 0x1u) != 0)
	{
		((((PIT_MemMapPtr)0x40037000u))->CHANNEL[PIT1]. TFLG)|=0x1u;
		for(i = 0; i < 8; i++)
		{
