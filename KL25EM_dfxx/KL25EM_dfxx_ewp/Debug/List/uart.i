#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\uart\\uart.c"
...
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\uart\\uart.h"
//============================================================================
//文件名称：uart.h
//功能概要：UART底层驱动构件头文件
...
void  enter_critical(void);
void  exit_critical(void);
#line 12 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\uart\\uart.h"
...
void  enter_critical(void);
void  exit_critical(void);
#line 14 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\uart\\uart.c"



//串口1、2号地址映射
const UART_MemMapPtr UART_ARR[] = {((UART_MemMapPtr)0x4006B000u), ((UART_MemMapPtr)0x4006C000u)};
...
void uart_init (UARTn uratn,uint32_t baud_rate)
{
  ...
  uint8_t temp;
  uint16_t  clk_kh ;
  UARTLP_MemMapPtr uartch1=((UARTLP_MemMapPtr)0x4006A000u);//声明uartch1为UARTLP_MemMapPtr结构体类型指针
  ...
  if(uratn==0)
  {
    ...
    ((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x400u;      //使能 UART0 时钟
    
    if(PTB16 == PTA1)
    {
      port_init( PTB16, ALT2);
    }
    else if((PTB16 == PTA15)  || (PTB16 == PTB16) || (PTB16 == PTD6) )
    {
      port_init( PTB16, ALT3);
    }
    else
    {
      ;                           //上诉条件都不满足，直接断言失败了，设置管脚有误？
    }
    
    if(PTB17 == PTA2)
    {
      port_init( PTB17, ALT2);
    }
    else if((PTB17 == PTA14)  || (PTB17 == PTB17) || (PTB17 == PTD7) )
    {
      port_init( PTB17, ALT3);
    }
    else
    {
      ;                           //上诉条件都不满足，直接断言失败了，设置管脚有误？
    ...
    ((((SIM_MemMapPtr)0x40047000u))->SOPT2) |= (((uint32_t)(((uint32_t)(1))<<26))&0xC000000u);   //UART0选择MCGFLLCLK_khz=48000Khz时钟源
    ((((SIM_MemMapPtr)0x40047000u))->SOPT2) |= 0x10000u;
    
    //暂时关闭串口0发送与接收功能
    uartch1->C2 &= ~(0x8u | 0x4u);
    
    //配置串口工作模式:8位无校验模式
    clk_kh = core_clk_khz/2 ;
    sbr = (uint_16)((clk_kh*1000)/(baud_rate * 16));
    temp = ((uartch1)->BDH) & ~((((uint8_t)(((uint8_t)(0x1F))<<0))&0x1Fu));
    ((uartch1)->BDH) = temp |  (((uint8_t)(((uint8_t)(((sbr & 0x1F00) >> 8)))<<0))&0x1Fu);
    ((uartch1)->BDL) = (uint8_t)(sbr & 0xFFu);
    
    //初始化控制寄存器、清标志位
    ((((UARTLP_MemMapPtr)0x4006A000u))->C4) = 0x0F;
    ((((UARTLP_MemMapPtr)0x4006A000u))->C1) = 0x00;
    ((((UARTLP_MemMapPtr)0x4006A000u))->C3) = 0x00;
    ((((UARTLP_MemMapPtr)0x4006A000u))->MA1) = 0x00;
    ((((UARTLP_MemMapPtr)0x4006A000u))->MA2) = 0x00;
    ((((UARTLP_MemMapPtr)0x4006A000u))->S1) |= 0x1F;
    ((((UARTLP_MemMapPtr)0x4006A000u))->S2) |= 0xC0;
  ...
  else
  {
    ...
    {
    case UART1:
      ((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x800u;
      
      if((PTC3 == PTA18) || (PTC3 == PTC3) || (PTC3 == PTE1) )
      {
        port_init( PTC3, ALT3);
      }
      else
      ...
      if((PTC4 == PTA19)  || (PTC4 == PTC4) || (PTC4 == PTE0) )
      {
        port_init( PTC4, ALT3);
      }
      else
    ...
    case UART2:
      ...
      ((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x1000u;
      
      if((PTD2 == PTD2) || (PTD2 == PTD4) || (PTD2 == PTE17))
      {
        port_init( PTD2, ALT3);
      }
      else if(PTD2 == PTE23)
      ...
      if((PTD3 == PTD3) || (PTD3 == PTD5) || (PTD3 == PTE16))
      {
        port_init( PTD3, ALT3);
      }
      else if(PTD3 == PTE22)
    ...
    //暂时关闭串口1、2发送与接收功能
    uartch2->C2 &= ~(0x8u | 0x4u);
    
    //配置波特率,KL25串口1、2时钟频率只能使用 Bus clock = 24M 总线时钟
    //配置串口工作模式,8位无校验模式
    uartch2->C1 = 0;
    sbr = (uint_16)((bus_clk_khz*1000)/(baud_rate * 16));
    temp = ((uartch2)->BDH) & ~((((uint8_t)(((uint8_t)(0x1F))<<0))&0x1Fu));
    ((uartch2)->BDH) = temp |  (((uint8_t)(((uint8_t)(((sbr & 0x1F00) >> 8)))<<0))&0x1Fu);
    ((uartch2)->BDL) = (uint8_t)(sbr & 0xFFu);
...
{
  UARTLP_MemMapPtr uartch1=((UARTLP_MemMapPtr)0x4006A000u);
  UART_MemMapPtr uartch2 = UART_ARR[uratn-1];
  if(0==uratn)
  {
    /* Wait until character has been received */
    while (!((uartch1->S1) & 0x20u ));
...
int uart_query (UARTn uratn)
{
  ...
  if(0==uratn)
  {
    return ((uartch1->S1) & 0x20u );
  }
  else
  {
   return ((uartch2->S1) & 0x20u);
  }  
...
void uart_irq_EN(UARTn uratn)
{
  ...
  if(0==uratn)
  {
    uartch1->C2 |= 0x20u;        //开放UART接收中断
  }
  else
    uartch2->C2 |= 0x20u;        //开放UART接收中断
...
void uart_irq_DIS(UARTn uratn)
{
  ...
  UART_MemMapPtr uartch2 = UART_ARR[uratn-1];
  if(0==uratn)
    uartch1->C2 &= ~0x20u;               //禁止UART接收中断
  else
    uartch2->C2 &= ~0x20u;               //禁止UART接收中断
