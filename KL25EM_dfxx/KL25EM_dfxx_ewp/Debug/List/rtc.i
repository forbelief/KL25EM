#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\rtc\\rtc.c"
//==========================================================================
//文件名称：RTC.c
...
#line 8 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\rtc\\rtc.c"
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\rtc\\rtc.h"
//==========================================================================
//文件名称：RTC.c
//功能概要：KL25 RTC底层驱动程序源文件
//版权所有：苏州大学飞思卡尔嵌入式中心(sumcu.suda.edu.cn)
...
void  enter_critical(void);
void  exit_critical(void);
#line 11 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\rtc\\rtc.h"
...
#line 9 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\rtc\\rtc.c"
...
{
	  //时能RTC模块时钟
	  ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= 0x20000000u;
	  //软件复位
	  disable_irq(20);
	  disable_irq(21);

	  ((((RTC_MemMapPtr)0x4003D000u))->CR)  = 0x1u;
	  ((((RTC_MemMapPtr)0x4003D000u))->CR)  &= ~0x1u;

	  if (((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x1u)
	  {
	      ((((RTC_MemMapPtr)0x4003D000u))->TSR) = 0x00000000;
	  }
	  ((((RTC_MemMapPtr)0x4003D000u))->TCR) = (((uint32_t)(((uint32_t)(0))<<8))&0xFF00u) | (((uint32_t)(((uint32_t)(0))<<0))&0xFFu);
	  //使能计数器
	  if (seconds >0)
	  {
	    enable_irq(21);
	    //选择呢LPO作为RTC时钟源
	    ((((SIM_MemMapPtr)0x40047000u))->SOPT1) |= (((uint32_t)(((uint32_t)(3))<<18))&0xC0000u);
	    ((((RTC_MemMapPtr)0x4003D000u))->IER) |= 0x10u;
	    ((((RTC_MemMapPtr)0x4003D000u))->SR) |= 0x10u;
	    ((((RTC_MemMapPtr)0x4003D000u))->TSR) = seconds;
	  }
	  else
	  {
	    ((((RTC_MemMapPtr)0x4003D000u))->IER) &= ~0x10u;
	  ...
	  if (alarm >0)
	  {
	    ((((RTC_MemMapPtr)0x4003D000u))->IER) |= 0x4u;
	    ((((RTC_MemMapPtr)0x4003D000u))->SR) |= 0x10u;
	    ((((RTC_MemMapPtr)0x4003D000u))->TAR) = alarm;
	    enable_irq(20);
	    //选择呢LPO作为RTC时钟源
	    ((((SIM_MemMapPtr)0x40047000u))->SOPT1) |= (((uint32_t)(((uint32_t)(3))<<18))&0xC0000u);  //选择LPO 1khz作为时钟输入
	  }
	  else
	  {
	    ((((RTC_MemMapPtr)0x4003D000u))->IER) &= ~0x4u;
