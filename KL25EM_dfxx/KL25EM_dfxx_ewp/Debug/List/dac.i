#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\dac\\dac.c"
...
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\dac\\dac.h"
//===========================================================================
//文件名称：dac.h
//功能概要：dac底层驱动构件头文件
...
void  enter_critical(void);
void  exit_critical(void);
#line 12 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\dac\\dac.h"
...
#line 15 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\dac\\dac.c"
...
void dac_init(uint8_t RefVoltage)
{
    ...
    //SIM_SCGC2 |= SIM_SCGC2_DAC0_MASK ;      //使能DAC 0
      ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |=0x80000000u;        //使能DAC0时钟
      dac_set(((DAC_MemMapPtr)0x4003F000u),VreRF);
}
