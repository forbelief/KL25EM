#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\cpu\\arm_cm0.c"
/*
 * File:		arm_cm0.c
...
void  enter_critical(void);
void  exit_critical(void);
#line 9 "F:\\KL25EM\\KL25EM_dfxx\\src\\cpu\\arm_cm0.c"
...
void stop (void)
{
	...
	((((SCB_MemMapPtr)0xE000E000u))->SCR) |= 0x4u;
...
void write_vtor (int vtor)
{
        ...
        ((((SCB_MemMapPtr)0xE000E000u))->VTOR) = vtor;
}
/***********************************************************************/
/*
...
void enable_irq (int irq)
{
    ...
    else
    {
      ...
      ((((NVIC_MemMapPtr)0xE000E100u))->ICPR) |= 1 << (irq%32);
      ((((NVIC_MemMapPtr)0xE000E100u))->ISER) |= 1 << (irq%32);
    }
}
/***********************************************************************/
/*
...
void disable_irq (int irq)
{
    ...
    if (irq > 32)
      ...
      ((((NVIC_MemMapPtr)0xE000E100u))->ICER) = 1 << (irq%32);
}
/***********************************************************************/
/*
...
void set_irq_priority (int irq, int prio)
{
    ...
    if (err != 1)
    {
        ...
        div = irq / 4;
        prio_reg = (uint_8 *)((uint_32)&((((NVIC_MemMapPtr)0xE000E100u))->IP[div]));
