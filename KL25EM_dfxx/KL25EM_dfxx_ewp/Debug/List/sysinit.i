#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\cpu\\sysinit.c"
...
#line 2 "F:\\KL25EM\\KL25EM_dfxx\\src\\cpu\\sysinit.c"
...
unsigned long core_clk_khz;       //内核时钟(KHz)
unsigned long core_clk_mhz;       //内核时钟(MHz)
unsigned long bus_clk_khz;        //外围总线时钟

void sys_init(void)  
{
  ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= 0x200u
			  | 0x400u
			  | 0x800u
			  | 0x1000u
			  | 0x2000u;
    ...
    /* 增强系统频率   可以在这里设置超频  */
    core_clk_mhz = pll_init(PLL48);

    
    //通过pll_init函数的返回值来计算内核时钟和外设时钟，便于其他函数可查询时钟频率
    core_clk_khz = core_clk_mhz * 1000;
    bus_clk_khz = core_clk_khz / (((((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) & 0x70000u) >> 16) +1);

   
    uart_init(UART0, 115200);    //初始化 printf 函数所用到的串口
