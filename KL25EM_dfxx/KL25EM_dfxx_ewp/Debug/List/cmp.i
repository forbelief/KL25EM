#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\cmp\\cmp.c"
...
**********************************************************************************/
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\cmp\\cmp.h"
//============================================================================
//文件名称：cmp.h
...
void  enter_critical(void);
void  exit_critical(void);
#line 13 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\cmp\\cmp.h"
...
#line 14 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\cmp\\cmp.c"
...
{
      //通过获取模块号选择比较器基址
    CMP_MemMapPtr cmpch = ((CMP_MemMapPtr)0x40073000u);
    ...
    //使能比较模块时钟
    ((((SIM_MemMapPtr)0x40047000u))->SCGC4) |=0x80000u;
    ...
    ((cmpch)->MUXCR) = (((uint8_t)(((uint8_t)(plusChannel))<<3))&0x38u)//正通道选择
                     | (((uint8_t)(((uint8_t)(minusChannel))<<0))&0x7u);//负通道选择    
    
    
    //选择输出引脚
    ((((PORT_MemMapPtr)0x4004B000u))->PCR[5])=(((uint32_t)(((uint32_t)(6))<<8))&0x700u);
        //CMP使能   
    ((cmpch)->CR1) |= 0x1u;
...
void cmp_dac_set_value(uint8_t value)
{
   //通过获取模块号选择比较器基址
   CMP_MemMapPtr cmpch = ((CMP_MemMapPtr)0x40073000u);
   ((cmpch)->DACCR) |= (((uint8_t)(((uint8_t)(value))<<0))&0x3Fu);
}
