#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio.c"
...
**********************************************************************************/
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio.h"
/******************** (C) COPYRIGHT 2011 蓝宙电子工作室 ********************
* 文件名       ： gpio.h
* 描述         ：工程模版实验
*
...
#line 1 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"
/******************** (C) COPYRIGHT 2011 蓝宙电子工作室 ********************
 * 文件名       ：gpio_cfg.h
 * 描述         ：gpio的端口定义头文件
 *
...
//定义PTA的端口  ——by 蓝宙
#line 48 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTB的端口  ——by 蓝宙
#line 82 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTC的端口  ——by 蓝宙
#line 116 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTD的端口  ——by 蓝宙
#line 150 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTE的端口  ——by 蓝宙
#line 184 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"



//定义PTA的输出输入方向  ——by 蓝宙
#line 220 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTB的输出输入方向  ——by 蓝宙
#line 254 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTC的输出输入方向  ——by 蓝宙
#line 288 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTD的输出输入方向  ——by 蓝宙
#line 322 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTE的输出输入方向  ——by 蓝宙
#line 356 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"


//定义PTA的输入端口  ——by 蓝宙
#line 391 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTB的输入端口  ——by 蓝宙
#line 425 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTC的输入端口  ——by 蓝宙
#line 459 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTD的输入端口  ——by 蓝宙
#line 493 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"

//定义PTE的输入端口  ——by 蓝宙
#line 527 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio_cfg.h"
...
#line 18 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio.h"
...
#line 14 "F:\\KL25EM\\KL25EM_dfxx\\src\\drivers\\gpio\\gpio.c"

//各端口基地址放入常数数据组PORTX[0]~PORTX[4]中
volatile struct PORT_MemMap *PORTX[5]={((PORT_MemMapPtr)0x40049000u),((PORT_MemMapPtr)0x4004A000u),
((PORT_MemMapPtr)0x4004B000u),((PORT_MemMapPtr)0x4004C000u),((PORT_MemMapPtr)0x4004D000u)};
//GPIO口基地址放入常数数据组GPIOx[0]~GPIOx[4]中
volatile struct GPIO_MemMap *GPIOx[5]={((GPIO_MemMapPtr)0x400FF000u),((GPIO_MemMapPtr)0x400FF040u),
((GPIO_MemMapPtr)0x400FF080u),((GPIO_MemMapPtr)0x400FF0C0u),((GPIO_MemMapPtr)0x400FF100u)};
...
void gpio_Interrupt_init(PTxn ptxn, GPIO_CFG cfg, GPIO_INP mode)
{
  ...
  ((PORTX[((ptxn)>>5)])->PCR[((ptxn)&0x1f)]) = (0 | (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | cfg | (((uint32_t)(((uint32_t)(mode))<<16))&0xF0000u) );
...
{	
  ...
  ((PORTX[((ptxn)>>5)])->PCR[((ptxn)&0x1f)])= (((uint32_t)(((uint32_t)(1))<<8))&0x700u);
  
  //根据带入参数dir，决定引脚为输出还是输入
  if (1 == dir)   //希望为输出
  {
    ((GPIOx[((ptxn)>>5)])->PDDR) |= (1 << ((ptxn)&0x1f));    //设置端口方向为输出
...
{	
  //返回引脚的状态
  return ((((GPIOx[(((ptxn)>>5))])->PDIR)>>(((ptxn)&0x1f)))&0x1) ;
}
